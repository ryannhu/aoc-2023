input = """.....487.599...........411...........................................574..679.136..........................30......255.......432............
....*......*............*..........&586..........................375...@..*....../.....835.............610*........./...............582.....
...
for row, line in enumerate(input):
    width = len(line) - 1
    i = 0
    while i < len(line) or number:
        c = line[i]
        if c.isnumeric():
            number = 1
            y = ""
            valid = False
            while i < width + 1 and line[i].isnumeric():
                # print(row, i)
            # check if number is valid
                if ((row > 0 and input[row - 1][i] in symbol) or 
                    (row < height and input[row + 1][i] in symbol) or
                    (row > 0 and i < width - 1 and input[row - 1][i + 1] in symbol) or
                    (row < height and input[row + 1][i - 1] in symbol) or
                    (row < height and i < width and input[row + 1][i + 1] in symbol) or
                    (row > 0 and input[row - 1][i - 1] in symbol) or
                    (i < width and input[row][i + 1] in symbol) or
                    (input[row][i - 1] in symbol)):
                        valid = True
                y += line[i]
                i += 1
